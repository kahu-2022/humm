exports.seed = async function(knex) {
  ...
  await knex('food-items').insert([
    ...
    {id: 2, name: 'Logan', donorRoom: '3', item: 'Tomato', quantity: '12', donateDate: '2022-02-19', useByDate: '2022-02-26', status: 'Claimed', claimedBy: 'Maria', claimerRoom: '9'},
    ...
    {id: 6, name: 'Maria', donorRoom: '9', item: 'Brown rice', quantity: '2 X bags', donateDate: '2022-02-12', useByDate: '2022-02-19', status: 'Claimed', claimedBy: 'Simon', claimerRoom: '13'},
    {id: 7, name: 'Simon', donorRoom: '13', item: 'Kumquat', quantity: '5', donateDate: '', useByDate: '2022-02-24', status: '2022-03-03', claimedBy: 'Available', claimerRoom: ''},
    {id: 8, name: 'Kevin', donorRoom: '19', item: 'Persimmon', quantity: '10', donateDate: '', useByDate: '2022-02-24', status: '2022-03-03', claimedBy: 'Available', claimerRoom: ''},
